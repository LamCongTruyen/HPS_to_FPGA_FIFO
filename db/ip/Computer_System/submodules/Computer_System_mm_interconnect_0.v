...
module Computer_System_mm_interconnect_0 (
	...
	wire  [125:0] fifo_hps_to_fpga_in_agent_rf_source_data;                   // fifo_HPS_to_FPGA_in_agent:rf_source_data -> fifo_HPS_to_FPGA_in_agent_rsp_fifo:in_data
	...
	wire  [125:0] fifo_hps_to_fpga_in_agent_rsp_fifo_out_data;                // fifo_HPS_to_FPGA_in_agent_rsp_fifo:out_data -> fifo_HPS_to_FPGA_in_agent:rf_sink_data
	...
	wire  [125:0] onchip_sram_s2_agent_rf_source_data;                        // Onchip_SRAM_s2_agent:rf_source_data -> Onchip_SRAM_s2_agent_rsp_fifo:in_data
	...
	wire  [125:0] onchip_sram_s2_agent_rsp_fifo_out_data;                     // Onchip_SRAM_s2_agent_rsp_fifo:out_data -> Onchip_SRAM_s2_agent:rf_sink_data
	...
	wire  [124:0] fifo_hps_to_fpga_in_agent_rp_data;                          // fifo_HPS_to_FPGA_in_agent:rp_data -> router_002:sink_data
	...
	wire          onchip_sram_s2_agent_rp_valid;                              // Onchip_SRAM_s2_agent:rp_valid -> router_003:sink_valid
	wire  [124:0] onchip_sram_s2_agent_rp_data;                               // Onchip_SRAM_s2_agent:rp_data -> router_003:sink_data
	wire          onchip_sram_s2_agent_rp_ready;                              // router_003:sink_ready -> Onchip_SRAM_s2_agent:rp_ready
	wire          onchip_sram_s2_agent_rp_startofpacket;                      // Onchip_SRAM_s2_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          onchip_sram_s2_agent_rp_endofpacket;                        // Onchip_SRAM_s2_agent:rp_endofpacket -> router_003:sink_endofpacket
	wire          router_src_valid;                                           // router:src_valid -> ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_sink_valid
	wire  [232:0] router_src_data;                                            // router:src_data -> ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_sink_data
	wire          router_src_ready;                                           // ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                         // router:src_channel -> ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_sink_channel
	...
	wire  [232:0] arm_a9_hps_h2f_axi_master_wr_limiter_cmd_src_data;          // ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire    [1:0] arm_a9_hps_h2f_axi_master_wr_limiter_cmd_src_channel;       // ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [232:0] rsp_mux_src_data;                                           // rsp_mux:src_data -> ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                          // ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                        // rsp_mux:src_channel -> ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_sink_channel
	...
	wire  [232:0] arm_a9_hps_h2f_axi_master_wr_limiter_rsp_src_data;          // ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_src_data -> ARM_A9_HPS_h2f_axi_master_agent:write_rp_data
	...
	wire    [1:0] arm_a9_hps_h2f_axi_master_wr_limiter_rsp_src_channel;       // ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_src_channel -> ARM_A9_HPS_h2f_axi_master_agent:write_rp_channel
	...
	wire  [232:0] router_001_src_data;                                        // router_001:src_data -> ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_sink_data
	wire          router_001_src_ready;                                       // ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                     // router_001:src_channel -> ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_sink_channel
	...
	wire  [232:0] arm_a9_hps_h2f_axi_master_rd_limiter_cmd_src_data;          // ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [1:0] arm_a9_hps_h2f_axi_master_rd_limiter_cmd_src_channel;       // ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [232:0] rsp_mux_001_src_data;                                       // rsp_mux_001:src_data -> ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                      // ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                    // rsp_mux_001:src_channel -> ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_sink_channel
	...
	wire  [232:0] arm_a9_hps_h2f_axi_master_rd_limiter_rsp_src_data;          // ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_src_data -> ARM_A9_HPS_h2f_axi_master_agent:read_rp_data
	...
	wire    [1:0] arm_a9_hps_h2f_axi_master_rd_limiter_rsp_src_channel;       // ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_src_channel -> ARM_A9_HPS_h2f_axi_master_agent:read_rp_channel
	...
	wire  [124:0] fifo_hps_to_fpga_in_burst_adapter_source0_data;             // fifo_HPS_to_FPGA_in_burst_adapter:source0_data -> fifo_HPS_to_FPGA_in_agent:cp_data
	...
	wire    [1:0] fifo_hps_to_fpga_in_burst_adapter_source0_channel;          // fifo_HPS_to_FPGA_in_burst_adapter:source0_channel -> fifo_HPS_to_FPGA_in_agent:cp_channel
	...
	wire  [124:0] onchip_sram_s2_burst_adapter_source0_data;                  // Onchip_SRAM_s2_burst_adapter:source0_data -> Onchip_SRAM_s2_agent:cp_data
	wire          onchip_sram_s2_burst_adapter_source0_ready;                 // Onchip_SRAM_s2_agent:cp_ready -> Onchip_SRAM_s2_burst_adapter:source0_ready
	wire    [1:0] onchip_sram_s2_burst_adapter_source0_channel;               // Onchip_SRAM_s2_burst_adapter:source0_channel -> Onchip_SRAM_s2_agent:cp_channel
	...
	wire  [124:0] router_002_src_data;                                        // router_002:src_data -> fifo_HPS_to_FPGA_in_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                       // fifo_HPS_to_FPGA_in_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                     // router_002:src_channel -> fifo_HPS_to_FPGA_in_rsp_width_adapter:in_channel
	...
	wire  [232:0] fifo_hps_to_fpga_in_rsp_width_adapter_src_data;             // fifo_HPS_to_FPGA_in_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [1:0] fifo_hps_to_fpga_in_rsp_width_adapter_src_channel;          // fifo_HPS_to_FPGA_in_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire          router_003_src_valid;                                       // router_003:src_valid -> Onchip_SRAM_s2_rsp_width_adapter:in_valid
	wire  [124:0] router_003_src_data;                                        // router_003:src_data -> Onchip_SRAM_s2_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                       // Onchip_SRAM_s2_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                     // router_003:src_channel -> Onchip_SRAM_s2_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                               // router_003:src_startofpacket -> Onchip_SRAM_s2_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                 // router_003:src_endofpacket -> Onchip_SRAM_s2_rsp_width_adapter:in_endofpacket
	wire          onchip_sram_s2_rsp_width_adapter_src_valid;                 // Onchip_SRAM_s2_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [232:0] onchip_sram_s2_rsp_width_adapter_src_data;                  // Onchip_SRAM_s2_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          onchip_sram_s2_rsp_width_adapter_src_ready;                 // rsp_demux_001:sink_ready -> Onchip_SRAM_s2_rsp_width_adapter:out_ready
	wire    [1:0] onchip_sram_s2_rsp_width_adapter_src_channel;               // Onchip_SRAM_s2_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          onchip_sram_s2_rsp_width_adapter_src_startofpacket;         // Onchip_SRAM_s2_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          onchip_sram_s2_rsp_width_adapter_src_endofpacket;           // Onchip_SRAM_s2_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> fifo_HPS_to_FPGA_in_cmd_width_adapter:in_valid
	wire  [232:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> fifo_HPS_to_FPGA_in_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                          // fifo_HPS_to_FPGA_in_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> fifo_HPS_to_FPGA_in_cmd_width_adapter:in_channel
	...
	wire  [124:0] fifo_hps_to_fpga_in_cmd_width_adapter_src_data;             // fifo_HPS_to_FPGA_in_cmd_width_adapter:out_data -> fifo_HPS_to_FPGA_in_burst_adapter:sink0_data
	...
	wire    [1:0] fifo_hps_to_fpga_in_cmd_width_adapter_src_channel;          // fifo_HPS_to_FPGA_in_cmd_width_adapter:out_channel -> fifo_HPS_to_FPGA_in_burst_adapter:sink0_channel
	...
	wire          cmd_mux_001_src_valid;                                      // cmd_mux_001:src_valid -> Onchip_SRAM_s2_cmd_width_adapter:in_valid
	wire  [232:0] cmd_mux_001_src_data;                                       // cmd_mux_001:src_data -> Onchip_SRAM_s2_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                      // Onchip_SRAM_s2_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                    // cmd_mux_001:src_channel -> Onchip_SRAM_s2_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                              // cmd_mux_001:src_startofpacket -> Onchip_SRAM_s2_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                // cmd_mux_001:src_endofpacket -> Onchip_SRAM_s2_cmd_width_adapter:in_endofpacket
	...
	wire  [124:0] onchip_sram_s2_cmd_width_adapter_src_data;                  // Onchip_SRAM_s2_cmd_width_adapter:out_data -> Onchip_SRAM_s2_burst_adapter:sink0_data
	...
	wire    [1:0] onchip_sram_s2_cmd_width_adapter_src_channel;               // Onchip_SRAM_s2_cmd_width_adapter:out_channel -> Onchip_SRAM_s2_burst_adapter:sink0_channel
	...
	wire    [1:0] arm_a9_hps_h2f_axi_master_wr_limiter_cmd_valid_data;        // ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [1:0] arm_a9_hps_h2f_axi_master_rd_limiter_cmd_valid_data;        // ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid

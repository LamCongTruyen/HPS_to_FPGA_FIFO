...
module soc_system_mm_interconnect_1 (
	...
	wire   [20:0] fifo_0_in_csr_agent_m0_address;                       // fifo_0_in_csr_agent:m0_address -> fifo_0_in_csr_translator:uav_address
	...
	wire  [112:0] fifo_0_in_csr_agent_rf_source_data;                   // fifo_0_in_csr_agent:rf_source_data -> fifo_0_in_csr_agent_rsp_fifo:in_data
	...
	wire  [112:0] fifo_0_in_csr_agent_rsp_fifo_out_data;                // fifo_0_in_csr_agent_rsp_fifo:out_data -> fifo_0_in_csr_agent:rf_sink_data
	...
	wire          fifo_0_in_csr_agent_rp_valid;                         // fifo_0_in_csr_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] fifo_0_in_csr_agent_rp_data;                          // fifo_0_in_csr_agent:rp_data -> router_002:sink_data
	wire          fifo_0_in_csr_agent_rp_ready;                         // router_002:sink_ready -> fifo_0_in_csr_agent:rp_ready
	wire          fifo_0_in_csr_agent_rp_startofpacket;                 // fifo_0_in_csr_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          fifo_0_in_csr_agent_rp_endofpacket;                   // fifo_0_in_csr_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                    // cmd_mux:src_valid -> fifo_0_in_csr_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                     // cmd_mux:src_data -> fifo_0_in_csr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                    // fifo_0_in_csr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                  // cmd_mux:src_channel -> fifo_0_in_csr_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                            // cmd_mux:src_startofpacket -> fifo_0_in_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                              // cmd_mux:src_endofpacket -> fifo_0_in_csr_burst_adapter:sink0_endofpacket
	wire          fifo_0_in_csr_burst_adapter_source0_valid;            // fifo_0_in_csr_burst_adapter:source0_valid -> fifo_0_in_csr_agent:cp_valid
	wire  [111:0] fifo_0_in_csr_burst_adapter_source0_data;             // fifo_0_in_csr_burst_adapter:source0_data -> fifo_0_in_csr_agent:cp_data
	wire          fifo_0_in_csr_burst_adapter_source0_ready;            // fifo_0_in_csr_agent:cp_ready -> fifo_0_in_csr_burst_adapter:source0_ready
	wire    [1:0] fifo_0_in_csr_burst_adapter_source0_channel;          // fifo_0_in_csr_burst_adapter:source0_channel -> fifo_0_in_csr_agent:cp_channel
	wire          fifo_0_in_csr_burst_adapter_source0_startofpacket;    // fifo_0_in_csr_burst_adapter:source0_startofpacket -> fifo_0_in_csr_agent:cp_startofpacket
	wire          fifo_0_in_csr_burst_adapter_source0_endofpacket;      // fifo_0_in_csr_burst_adapter:source0_endofpacket -> fifo_0_in_csr_agent:cp_endofpacket
	...
	wire          fifo_0_in_csr_agent_rdata_fifo_out_valid;             // fifo_0_in_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] fifo_0_in_csr_agent_rdata_fifo_out_data;              // fifo_0_in_csr_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          fifo_0_in_csr_agent_rdata_fifo_out_ready;             // avalon_st_adapter:in_0_ready -> fifo_0_in_csr_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                        // avalon_st_adapter:out_0_valid -> fifo_0_in_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                         // avalon_st_adapter:out_0_data -> fifo_0_in_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                        // fifo_0_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                        // avalon_st_adapter:out_0_error -> fifo_0_in_csr_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (fifo_0_in_csr_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fifo_0_in_csr_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fifo_0_in_csr_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fifo_0_in_csr_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fifo_0_in_csr_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fifo_0_in_csr_burst_adapter_source0_channel),       //                .channel
	...
	soc_system_mm_interconnect_1_router_002 router_002 (
		.sink_ready         (fifo_0_in_csr_agent_rp_ready),                //      sink.ready
		.sink_valid         (fifo_0_in_csr_agent_rp_valid),                //          .valid
		.sink_data          (fifo_0_in_csr_agent_rp_data),                 //          .data
		.sink_startofpacket (fifo_0_in_csr_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (fifo_0_in_csr_agent_rp_endofpacket),          //          .endofpacket
		.clk                (sys_sdram_pll_0_sys_clk_clk),                 //       clk.clk
		.reset              (fifo_0_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
